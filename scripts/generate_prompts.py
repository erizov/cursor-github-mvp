...
def get_algorithm_type_from_algorithm(algorithm: str) -> str:
    ...
    if any(x in alg_lower for x in ["logistic", "svm", "random forest (classification)", "naive bayes", "knn", "bert", "roberta"]):
        ...
        return "Time Series"
    elif any(x in alg_lower for x in ["bert", "roberta", "text", "nlp"]):
        return "NLP"
    ...
    elif any(x in alg_lower for x in ["reinforcement", "dqn", "ppo", "rl"]):
